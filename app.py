...
# 环境变量
UUID = os.environ.get('UUID', '97fa5cf9-f8c7-4452-a8fa-e498413c53f1')   # 节点UUID
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'jianxian.apkk.cloudns.org:56880')    # 哪吒v0填写格式: nezha.xxx.com  哪吒v1填写格式: nezha.xxx.com:8008
NEZHA_PORT = os.environ.get('NEZHA_PORT', '')        # 哪吒v1请留空，哪吒v0 agent端口
NEZHA_KEY = os.environ.get('NEZHA_KEY', 'VKj4hobStciN4Ze3YsUvbpqwrWZco1lt')          # 哪吒v0或v1密钥，哪吒面板后台命令里获取
DOMAIN = os.environ.get('DOMAIN', 'stre8989.streamlit.app')                # 项目分配的域名或反代后的域名,不包含https://前缀,例如: domain.xxx.com
SUB_PATH = os.environ.get('SUB_PATH', 'jianxianapp')         # 节点订阅token
NAME = os.environ.get('NAME', 'xianshengkk')                    # 节点名称
